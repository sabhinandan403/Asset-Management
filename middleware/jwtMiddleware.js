 ...
 * Abhinandan Kumar         January 30, 2024      Initially Created
 * -----------------------------------------------------------------------------------
 */


const jwt = require('jsonwebtoken');
const secretKey = 'assetManagement'; 
...
function jwtMiddleware(req, res, next) {
  ...
  if (email) {
    ...
    res.status(401).json({ success: false, message: 'Unauthorized: email not provided' });
  }
}
