document.addEventListener('DOMContentLoaded', function () {
  ...
  const getPendingIssuesCount = async () => {
    try {
      ...
      if (!flag) {
        ...
        // issueInformation = await getIssueMessage();
        // var info = await issueInformation
        // console.log('issueInformation is: ' , info)
        // if(issueInformation !== null){
        //     Swal.fire({
        //         icon:'info',
        //         text:`${info}`,
        //         title:'New request is raised'
        //     }).then(()=>{
  ...
  //     try{
  //         const messageResponse = await fetch('/asset/getIssueMessage')
  //         if (!messageResponse.ok) {
  //             throw error
  //         }
  //         const message = await messageResponse.json();
  //         console.log('data from getIssueMessage fucntion :', message.data.issueInformation)
  //         return message.data.issueInformation

  //     }catch(error){
  //         console.log('Error fetching messages :', error);
  //         Swal.fire({
  //             icon:'error',
  //             text:'Error in getting issue information',
  //             title:'Error'
  //         })
  //     }
  // }
