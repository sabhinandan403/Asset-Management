...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  const budgetApiUrl = '/asset/getBudget'
  ...
  function populateUpdateBudgetModal (data) {
    ...
    const modifiedAt = formatDate(data.modified_at)
  ...
  const allocatedBudgetCard = document.getElementById('allocatedBudgetCard')
  ...
  const budgetAvailableCard = document.getElementById('budgetAvailableCard')
  budgetAvailableCard.addEventListener('click', async function () {
    document.getElementById('updateAllocatedBudget').value = document.getElementById('allocatedBudget').innerText
    $('#updateBudgetModal').modal('show')
  })

  const budgetUtilisedCard = document.getElementById('budgetUtilisedCard')
  ...
  const allocatedAssetsCard = document.getElementById('allocatedAssetsCard')
  ...
  addBudgetForm.addEventListener('submit', async (event) => {
    ...
    const allocatedBudget = document.getElementById('newAllocatedBudget').value
    const budgetYear = document.getElementById('budgetYearInput').value
    // Parse the input value to ensure it's a valid number
    const budgetAmount = parseFloat(allocatedBudget)
  ...
  document.getElementById('newAllocatedTo').addEventListener('input', function () {
    ...
    const team = document.getElementById('newTeam').value
    const filteredEmployeesTeamWise = employeeList.filter(employee =>
      employee.team.includes(team))
    if (searchQuery) {
  ...
  registerAssetForm.addEventListener('submit', async (event) => {
    ...
    if (assetStatus === 'allocated' || assetStatus === 'Allocated' || !team === 'Not Allocated') {
      ...
      const allocatedToDataSet = document.getElementById('newAllocatedTo').dataset.employeeID
    ...
    const assetVendor = document.getElementById('newAssetVendors').value
    ...
    const assetPrice = document.getElementById('newAssetPrice').value
  ...
  const UpdateBudgetFormSubmit = async (assetPrice) => {
    ...
    let utilizedBudget = document.getElementById('updateUtilizedBudget').value
  ...
  const handleUpdateBudgetFormSubmit = async (event) => {
    ...
    let allocatedBudget = document.getElementById('updateAllocatedBudget').value
    let currentAllocatedBudget = document.getElementById('allocatedBudget').innerText
